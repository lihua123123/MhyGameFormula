...
| 破盾类型/盾类型 | 火盾 | 水盾  | 雷盾  | 冰盾 |          冻盾           | 风盾 |          岩盾           | 草盾  | 木盾  |
| :-------------: | :--: | :---: | :---: | :--: | :---------------------: | :--: | :---------------------: | :---: | :---: |
|       火        |  0   |  0.5  |   1   |  2   |            2            | max  |            0            | 0.4/s | 0.4/s |
|       水        |  2   |   0   | 0.4/s |  0   |            0            | max  |            0            |  0.5  |   0   |
|       雷        |  1   | 0.4/s |   0   |  1   |            1            | max  |            0            |   1   |   0   |
|       冰        | 0.5  |   1   |   1   |  0   |            0            | max  |         2(结晶)         |   0   |   0   |
|       风        | 0.5  |  0.5  |  0.5  | 0.5  |           0.5           |  0   |            0            |   0   |   0   |
|       岩        | 0.5  |  0.5  |  0.5  | 0.5  |           0.5           |  0   |            0            |   0   |   0   |
|       草        |  0   |   2   |   1   |  0   |            0            |  0   |            0            |   0   |   0   |
|      近战       |      |       |       |      |            0            |      |     $削韧值 / 500$      |       |       |
...
>
> 风盾目前只有`风拳前锋军`有，而且机制是染色盾，所以不过多研究
> 岩盾只能用冰岩结晶破的原因是：岩盾和岩造物只能附着冰
> `钟离` 的元素战技会吸收周围 $6U$ 岩元素
>
...
物体盾只能附着冰元素且大多为岩盾，因此可以先附着冰后再用岩破盾
