...
锋御代理人部分招式造成锐化伤害时会为敌人积累**残痕值**，当**残痕值**积累到 $600$ 点时会使敌人进入[**残痕**]，此时御锋代理人使用**特定招式**命中该敌人后会消耗一层[**残痕**]，并触发**毁伤**，单一敌人最多积累三层[**残痕**]

**残痕值**的积累视为全队共享，触发**毁伤**时仅使用**触发者面板**

### 毁伤

**毁伤**由御锋代理人触发，视为锐化伤害，与普通锐化伤害不同的是**毁伤**是范围伤害
